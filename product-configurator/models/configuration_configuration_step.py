...
class ConfigurationConfigurationStep(BaseModel):
    """
    ...
    options: Optional[List[ConfigurationStepOption]] = None
    has_multiple_selection: Optional[StrictBool] = Field(default=None, alias="hasMultipleSelection")
    __properties: ClassVar[List[str]] = ["id", "grn", "label", "options", "hasMultipleSelection"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ConfigurationConfigurationStep from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ConfigurationConfigurationStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "options": [ConfigurationStepOption.from_dict(_item) for _item in obj.get("options")] if obj.get("options") is not None else None,
