...
class ProductconfiguratorconfigurationOption(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "grn", "label", "position", "swatch", "enabled", "optionProperties", "hasQuantity"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductconfiguratorconfigurationOption from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductconfiguratorconfigurationOption from a dict"""
        if obj is None:
            return None
