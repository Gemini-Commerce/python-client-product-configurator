...
class OptionListOptionsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["options", "nextPageToken"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OptionListOptionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OptionListOptionsResponse from a dict"""
        if obj is None:
            return None
