...
class ProductconfiguratorconfigurationStep(BaseModel):
    """
    ...
    options: Optional[List[ProductconfiguratorconfigurationOption]] = None
    enabled: Optional[StrictBool] = None
    has_multiple_selection: Optional[StrictBool] = Field(default=None, alias="hasMultipleSelection")
    __properties: ClassVar[List[str]] = ["id", "grn", "label", "description", "subjectToStepId", "position", "isRequired", "options", "enabled", "hasMultipleSelection"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductconfiguratorconfigurationStep from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductconfiguratorconfigurationStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "options": [ProductconfiguratorconfigurationOption.from_dict(_item) for _item in obj.get("options")] if obj.get("options") is not None else None,
