...
class ProductconfiguratoroptionEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "grn", "label", "position", "swatch", "externalReferenceId", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductconfiguratoroptionEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductconfiguratoroptionEntity from a dict"""
        if obj is None:
            return None
