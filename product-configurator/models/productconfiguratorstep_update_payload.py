...
class ProductconfiguratorstepUpdatePayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["label", "description", "position", "isRequired", "subjectToStepId", "hasMultipleSelection", "optionsHaveQuantity"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductconfiguratorstepUpdatePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductconfiguratorstepUpdatePayload from a dict"""
        if obj is None:
            return None
