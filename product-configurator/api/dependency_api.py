...
class DependencyApi:
    ...
    @validate_call
    def product_configurator_create_dependency(
        self,
        tenant_id: StrictStr,
        step_id: StrictStr,
        ...
        :type step_id: str
        :param body: (required)
        :type body: ProductConfiguratorCreateDependencyRequest
        ...
        _param = self._product_configurator_create_dependency_serialize(
            tenant_id=tenant_id,
            step_id=step_id,
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductconfiguratordependencyEntity",
            '400': "GooglerpcStatus",
            '401': "GooglerpcStatus",
            '500': "GooglerpcStatus",
        }
    ...
    @validate_call
    def product_configurator_create_dependency_with_http_info(
        self,
        tenant_id: StrictStr,
        step_id: StrictStr,
        body: ProductConfiguratorCreateDependencyRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductconfiguratordependencyEntity]:
        """Create Dependency
    ...
    @validate_call
    def product_configurator_create_dependency_without_preload_content(
        self,
        tenant_id: StrictStr,
        step_id: StrictStr,
        body: ProductConfiguratorCreateDependencyRequest,
    ...
    def _product_configurator_create_dependency_serialize(
        self,
        tenant_id,
        step_id,
        body,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{tenantId}/step/{stepId}/dependency/create',
    ...
    @validate_call
    def product_configurator_delete_dependency(
        self,
        tenant_id: StrictStr,
        ...
        _param = self._product_configurator_delete_dependency_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def product_configurator_delete_dependency_with_http_info(
        self,
        tenant_id: StrictStr,
        dependency_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def product_configurator_delete_dependency_without_preload_content(
        self,
        tenant_id: StrictStr,
        dependency_id: StrictStr,
        _request_timeout: Union[
    ...
    def _product_configurator_delete_dependency_serialize(
        self,
        tenant_id,
        dependency_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/{tenantId}/dependency/{dependencyId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def product_configurator_list_dependencies(
        self,
        tenant_id: StrictStr,
        page_size: StrictInt,
        ...
        :type page_size: int
        :param body: (required)
        :type body: ProductConfiguratorListDependenciesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._product_configurator_list_dependencies_serialize(
            tenant_id=tenant_id,
            page_size=page_size,
            body=body,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DependencyListDependenciesResponse",
            '400': "GooglerpcStatus",
            '401': "GooglerpcStatus",
            '500': "GooglerpcStatus",
        }
    ...
    @validate_call
    def product_configurator_list_dependencies_with_http_info(
        self,
        tenant_id: StrictStr,
        page_size: StrictInt,
        body: ProductConfiguratorListDependenciesRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DependencyListDependenciesResponse]:
        """List Dependencies
    ...
    @validate_call
    def product_configurator_list_dependencies_without_preload_content(
        self,
        tenant_id: StrictStr,
        page_size: StrictInt,
        body: ProductConfiguratorListDependenciesRequest,
    ...
    def _product_configurator_list_dependencies_serialize(
        self,
        tenant_id,
        page_size,
        body,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{tenantId}/page-size/{pageSize}/dependencies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def product_configurator_update_dependency(
        self,
        tenant_id: StrictStr,
        dependency_id: StrictStr,
        ...
        :type dependency_id: str
        :param body: (required)
        :type body: ProductConfiguratorUpdateDependencyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._product_configurator_update_dependency_serialize(
            tenant_id=tenant_id,
            dependency_id=dependency_id,
            body=body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def product_configurator_update_dependency_with_http_info(
        self,
        tenant_id: StrictStr,
        dependency_id: StrictStr,
        body: ProductConfiguratorUpdateDependencyRequest,
    ...
    @validate_call
    def product_configurator_update_dependency_without_preload_content(
        self,
        tenant_id: StrictStr,
        dependency_id: StrictStr,
        body: ProductConfiguratorUpdateDependencyRequest,
    ...
    def _product_configurator_update_dependency_serialize(
        self,
        tenant_id,
        dependency_id,
        body,
